...
While this is decently complicated as a whole, each individual piece is rather simple if you understand the basics. 
...
3. Use the instructions at the top of each YAML to replace the variables with the proper values for your installation.
